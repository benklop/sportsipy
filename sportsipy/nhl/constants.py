...
SCHEDULE_SCHEME = {
    'game': 'td[data-stat="team_game_num_season"]:first',
    'date': 'td[data-stat="date"]:first',
    'time': 'td[data-stat="time_game"]:first',
    'location': 'td[data-stat="game_location"]:first',
    'opponent_abbr': 'td[data-stat="opp_name_abbr"]:first',
    'opponent_name': 'td[data-stat="opp_name_abbr"]:first',
    'goals_scored': 'td[data-stat="goals"]:first',
    'goals_allowed': 'td[data-stat="goals_against"]:first',
    'result': 'td[data-stat="team_game_result"]:first',
    ...
    'opp_penalties_in_minutes': 'td[data-stat="opp_pen_min"]:first',
    ...
    'corsi_for': 'td[data-stat="tm_5on5_corsi_for"]:first',
    'corsi_against': 'td[data-stat="tm_gm_5on5_corsi_against"]:first',
    'corsi_for_percentage': 'td[data-stat="tm_gm_5on5_corsi_pct"]:first',
    'fenwick_for': 'td[data-stat="tm_5on5_fenwick_for"]:first',
    'fenwick_against': 'td[data-stat="tm_gm_5on5_fenwick_against"]:first',
    'fenwick_for_percentage': 'td[data-stat="tm_gm_5on5_fenwick_pct"]:first',
    ...
    'offensive_zone_start_percentage': 'td[data-stat="tm_5on5_zs_offense_pct"]:first',
    'pdo': 'td[data-stat="tm_5on5_pdo_team"]:first'
}
